  ...
  describe("Category Management", () => {
    ...
    test("should get category statistics", () => {
      ...
      taskController.createTask(
        TestDataFactory.createValidTaskData({ category: "personal" })
      );
      taskController.createTask(
        TestDataFactory.createValidTaskData({ category: "study" })
      );
    ...
    test("should update task category", () => {
      // Act
      const response = taskController.updateTaskCategory(
        testTask.id,
        "personal"
      );
