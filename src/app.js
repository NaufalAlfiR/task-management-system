...
function createTaskHTML(task) {
  ...
  return `
        <div class="task-item ${priorityClass} ${completedClass}" data-task-id="${
    task.id
  }">
            ...
            <div class="task-actions">
                <button class="btn btn-toggle" onclick="handleTaskToggle('${
                  task.id
                }')" title="${
    task.completed ? "Mark incomplete" : "Mark complete"
                ...
                <button class="btn btn-delete" onclick="handleTaskDelete('${
                  task.id
                }')" title="Delete task">
                    🗑️
                </button>
